...
:ref:`Model Alignment by Reinforce <model-aligner-reinforce>`
   Reinforce is a simple policy optimization algorithm. Rather than maximizing a value function as in PPO, Reinforce directly attempts to maximize the policy's reward, therefore simplifying training.
