...
def main(cfg) -> None:
    ...
    tasks_to_environments = {k:MathEnvironment(cfg.trainer.grpo.environments.math) for k in {"aime24", "aime25", "amc23", "math", "qwq_sol_gen_no_ans_c4", "qwq_sol_gen_no_ans_c7", "qwq_sol_gen_no_ans_olymp_pr_gt03", "qwq_sol_gen_no_ans_olymp_pr_lt03", "deepscaler"}}
    ...
    tasks_to_environments["code_livecodebench"] = CodeEnvironment(cfg.trainer.grpo.environments.code)
