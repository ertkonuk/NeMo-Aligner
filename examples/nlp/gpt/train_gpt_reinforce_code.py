...
from nemo_aligner.algorithms.reinforce_coding import ReinforceCodeTrainer
from nemo_aligner.models.nlp.gpt.reward_critic_clients import CodeEvaluator
...
def main(cfg) -> None:
    ...
    train_ds, validation_ds, _ = build_train_valid_test_ifeval_datasets(
        cfg=cfg.model,
    ...
    collate_fn = collate_with_args(max_seqlen, eos_id, cfg)
    ...
    evaluator = CodeEvaluator(cfg.remote_critic_rm)
    reinforce_trainer = ReinforceCodeTrainer(
