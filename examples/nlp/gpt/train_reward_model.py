...
def main(cfg) -> None:
    ...
    ptl_model.iterative_data_smoothing = cfg.trainer.rm.get("iterative_data_smoothing")
    ...
    train_ds.iterative_data_smoothing = cfg.trainer.rm.get("iterative_data_smoothing")
